...
class TicketCategoryController extends Controller
{
    ...
    public function store(TicketCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success', 'دسته بندی جدید با موفقیت ایجاد شد');
    }
    ...
    public function update(TicketCategoryRequest $request, TicketCategory $ticketCategory)
    {
        ...
        $ticketCategory = $ticketCategory->update($inputs);
    ...
    public function destroy(TicketCategory $ticketCategory)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success', 'دسته بندی جدید با موفقیت حذف شد');
    }
