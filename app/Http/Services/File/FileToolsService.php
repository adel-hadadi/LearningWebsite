...
class FileToolsService
{
    ...
    protected function provider()
    {
        ...
        $finalFileDirectory = empty($this->exclusiveDirectory) ? $this->getfileDirectory() : $this->exclusiveDirectory . DIRECTORY_SEPARATOR .  $this->getfileDirectory();
