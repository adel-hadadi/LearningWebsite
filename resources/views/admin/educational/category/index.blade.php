        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.educational.category.create') }}" class="btn btn-info btn-sm">ایجاد دسته
                        بندی</a>
                        ...
                        <tbody>
                            @foreach ($categories as $key => $category)
                                <tr>
                                    ...
                                    <td>{{ $category->name }}</td>
                                    <td>
                                        <img src="{{ asset($category->image['indexArray'][$category->image['currentImage']]) }}"
