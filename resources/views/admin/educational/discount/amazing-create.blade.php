...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> افزودن کالا به فروش شگفت انگیز</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    <h5>
                        افزودن کالا به فروش شگفت انگیز
                    </h5>
                </section>
                ...
                <section>
                    <form action="{{ route('admin.educational.discount.amazingSale.store') }}" method="POST">
                        @csrf
                        <section class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="course_id" id="course_id" class="form-control form-control-sm">
                                        ...
                                        @foreach ($courses as $course)
                                            <option value="{{ $course->id }}" @if (old('course_id') == $course->id)
                                                selected
